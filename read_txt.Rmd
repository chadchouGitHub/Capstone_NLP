...
getblog<- grep("to see[^ ]* this weekend",nLpBlogs, value=T)
gettwitter<- grep("to see[^ ]* this weekend",nLpTwitter, value=T)
getnews<- grep("to see[^ ]* this weekend",nLpNews, value=T)
